...
<head>
    ...
    <style>
        ...
        .register-container {
            width: 340px;  
            background-color: rgba(204, 0, 0, 0.3); /* Semi-transparent red */
            padding: 40px;
        ...
        h2 {
            color: #cc0000; /* Deep red for the heading */
            font-size: 2rem;
            margin-bottom: 20px;
        }
        ...
        form input:focus, form button:focus {
            border-color: #ff4d4d; /* Lighter red for focus */
            outline: none;
        }

        form button {
            background-color: #cc0000; /* Bold red button */
            color: white;
            border: none;
            cursor: pointer;
